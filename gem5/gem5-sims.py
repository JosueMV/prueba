...
cache_configs = [
    {
        "binary": f"/home/arqui/lab2/laboratorio-2-grupo8/benchmark/array/permutation_64_bin",
        "l1i_size": '16kB',
        "l1i_assoc": 2,
        "l1d_size": '64kB',
        "l1d_assoc": 2,
    ...
    {
        "binary": f"/home/arqui/lab2/laboratorio-2-grupo8/benchmark/array/unrolling_64_bin",
        "l1i_size": '16kB',
        "l1i_assoc": 2,
        "l1d_size": '64kB',
        "l1d_assoc": 2,
     ...
     {
        "binary": f"/home/arqui/lab2/laboratorio-2-grupo8/benchmark/array/tilin_64_bin",
        "l1i_size": '16kB',
        "l1i_assoc": 2,
        "l1d_size": '64kB',
        "l1d_assoc": 2,
    ...
    {
        "binary": f"/home/arqui/lab2/laboratorio-2-grupo8/benchmark/array/permutation_128_bin",
        "l1i_size": '16kB',
        "l1i_assoc": 2,
        "l1d_size": '64kB',
        "l1d_assoc": 2,
    ...
    {
        "binary": f"/home/arqui/lab2/laboratorio-2-grupo8/benchmark/array/unrolling_128_bin",
        "l1i_size": '16kB',
        "l1i_assoc": 2,
        "l1d_size": '64kB',
        "l1d_assoc": 2,
     ...
     {
        "binary": f"/home/arqui/lab2/laboratorio-2-grupo8/benchmark/array/tilin_128_bin",
        "l1i_size": '16kB',
        "l1i_assoc": 2,
        "l1d_size": '64kB',
        "l1d_assoc": 2,
...
df.to_csv(f'/home/arqui/lab2/laboratorio-2-grupo8/gem5/simulation_results_tresPruebas.csv', index=False)
